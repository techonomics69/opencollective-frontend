...
<Meta title="Design system/StyledButton" component={StyledButton} />
...
<Canvas>
  <Story name="Button Sizes">
    <StyledButton buttonSize="xLarge">Extra Large</StyledButton>
    <StyledButton buttonSize="large">Large</StyledButton>
    <StyledButton buttonSize="medium">Medium</StyledButton>
    <StyledButton buttonSize="small">Small</StyledButton>
    <StyledButton buttonSize="tiny">Tiny</StyledButton>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Button styles">
    {Object.keys(theme.buttons).map(buttonStyle => (
      <div key={buttonStyle} style={{ marginBottom: 16 }}>
        <h3>{buttonStyle}</h3>
        <StyledButton buttonStyle={buttonStyle} buttonSize="large" disabled>
          Disabled
        </StyledButton>
        <StyledButton buttonStyle={buttonStyle} buttonSize="large">
          Default
        </StyledButton>
        <StyledButton buttonStyle={buttonStyle} buttonSize="large" loading>
          Loading
        </StyledButton>
      </div>
    ))}
